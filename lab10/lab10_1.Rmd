...
```{r}
life_history %>% 
  count(order, sort=T) %>%  # F will sort alphabetically, T sorts by counts
...
# 1 continuous variable and 1 categorical variable
```{r}
elephants %>% 
