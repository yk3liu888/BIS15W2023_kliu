...
```
## # A tibble: 734 × 10
##    name       gender eye_c…¹ race  hair_…² height pulis…³ skin_…⁴ align…⁵ weight
...
```
## # A tibble: 3 × 10
##   name      gender eye_color race  hair_…¹ height pulis…² skin_…³ align…⁴ weight
##   <chr>     <chr>  <chr>     <chr> <chr>    <dbl> <chr>   <chr>   <chr>    <dbl>
...
## # … with abbreviated variable names ¹​hair_color, ²​pulisher, ³​skin_color,
## #   ⁴​alignment
```
...
## # … with abbreviated variable names ¹​eye_color, ²​hair_color, ³​pulisher,
...
```
## # A tibble: 8 × 10
##   name       gender eye_co…¹ race  hair_…² height pulis…³ skin_…⁴ align…⁵ weight
##   <chr>      <chr>  <chr>    <chr> <chr>    <dbl> <chr>   <chr>   <chr>    <dbl>
## 1 Bloodaxe   Female blue     Human Brown    218   Marvel… <NA>    bad        495
## 2 Darkseid   Male   red      New … No Hair  267   DC Com… grey    bad        817
...
```
## # A tibble: 2 × 2
##   `accelerated_healing & durability & super_strength`     n
##   <lgl>                                               <int>
## 1 FALSE                                                 570
## 2 TRUE                                                   97
```
...
```
## # A tibble: 1 × 6
##   durability super_strength energy_blasts stamina teleportation energy_manipul…¹
##   <lgl>      <lgl>          <lgl>         <lgl>   <lgl>         <lgl>           
## 1 TRUE       TRUE           TRUE          TRUE    TRUE          TRUE            
## # … with abbreviated variable name ¹​energy_manipulation
```
