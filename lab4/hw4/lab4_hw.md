...
## [1] 13039918
```
Herbivores have larger `mean.hra.m2` on average.
...
```r
deer <- select(deer_1, "mean.mass.g", "log10.mass", "family", "genus", "species")
deer
```
...
```r
select(deer_1, "common.name","species")
```
...
##  1 moose             alces      
##  2 chital            axis       
##  3 roe deer          capreolus  
##  4 red deer          elaphus    
##  5 sika deer         nippon     
##  6 fallow deer       dama       
##  7 Reeves's muntjac  reevesi    
##  8 mule deer         hemionus   
##  9 white-tailed deer virginianus
## 10 pampas deer       bezoarticus
## 11 pudu              puda       
## 12 reindeer          tarandus
```
Alces deer is the largest. Its common name is moose.
...
```r
select(snake, "common.name","species")
```
...
##    common.name           species                 
##    <chr>                 <chr>                   
##  1 western worm snake    vermis                  
##  2 eastern worm snake    viridis                 
##  3 racer                 constrictor             
##  4 yellow bellied racer  constrictor flaviventris
##  5 ringneck snake        punctatus               
##  6 eastern indigo snake  couperi                 
##  7 great plains ratsnake guttata emoryi          
##  8 western ratsnake      obsoleta                
##  9 hognose snake         platirhinos             
## 10 European whipsnake    viridiflavus            
## # … with 31 more rows
```
